...
var GridSelectBox = function (_React$Component) {
    _inherits(GridSelectBox, _React$Component);

    function GridSelectBox(props) {
        _classCallCheck(this, GridSelectBox);

        var _this = _possibleConstructorReturn(this, (GridSelectBox.__proto__ || Object.getPrototypeOf(GridSelectBox)).call(this, props));

        _this.state = {
            isToggleOn: false
        };
        _this.handleClick = _this.handleClick.bind(_this);
        _this.handleSelectButtonClick = _this.handleSelectButtonClick.bind(_this);
        return _this;
    }

    _createClass(GridSelectBox, [{
        key: "handleClick",
        ...
        value: function handleSelectButtonClick(value) {
            this.handleClick();
                        ...
                        this.props.options.map(function (option) {
                            return _react2.default.createElement(
                                ...
                                { type: "button", className: _styles2.default.gridSelectBoxSelectButton, onClick: function onClick() {
                                        return _this2.handleSelectButtonClick(option.value);
                                    } },
                                option.label
                            );
                        })
...
var SpecialCharacterCommand = function (_Command) {
    _inherits(SpecialCharacterCommand, _Command);

    function SpecialCharacterCommand() {
        _classCallCheck(this, SpecialCharacterCommand);

        return _possibleConstructorReturn(this, (SpecialCharacterCommand.__proto__ || Object.getPrototypeOf(SpecialCharacterCommand)).apply(this, arguments));
    }

    _createClass(SpecialCharacterCommand, [{
        key: 'execute',
    ...
    return SpecialCharacterCommand;
...
exports.default = function (configuration) {
    return function (_Plugin) {
        _inherits(SpecialCharacterEditing, _Plugin);

        function SpecialCharacterEditing() {
            _classCallCheck(this, SpecialCharacterEditing);

            return _possibleConstructorReturn(this, (SpecialCharacterEditing.__proto__ || Object.getPrototypeOf(SpecialCharacterEditing)).apply(this, arguments));
        }

        _createClass(SpecialCharacterEditing, [{
            key: 'init',
            value: function init() {
        ...
        return SpecialCharacterEditing;
...
var SpecialCharactersPlugin = function (_Plugin) {
    _inherits(SpecialCharactersPlugin, _Plugin);

    function SpecialCharactersPlugin() {
        _classCallCheck(this, SpecialCharactersPlugin);

        return _possibleConstructorReturn(this, (SpecialCharactersPlugin.__proto__ || Object.getPrototypeOf(SpecialCharactersPlugin)).apply(this, arguments));
    }

    _createClass(SpecialCharactersPlugin, [{
        key: 'init',
        value: function init() {
            var editor = this.editor;
        }
...
var SpecialCharacterSelector = (_temp = _class = function (_PureComponent) {
    _inherits(SpecialCharacterSelector, _PureComponent);

    function SpecialCharacterSelector() {
        var _ref;

        _classCallCheck(this, SpecialCharacterSelector);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        var _this = _possibleConstructorReturn(this, (_ref = SpecialCharacterSelector.__proto__ || Object.getPrototypeOf(SpecialCharacterSelector)).call.apply(_ref, [this].concat(args)));

        _this.handleOnSelect = _this.handleOnSelect.bind(_this);
        return _this;
    }

    _createClass(SpecialCharacterSelector, [{
        key: 'render',
        value: function render() {
            var _this2 = this;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_GridSelectBox2.default, {
                    ...
                    onSelect: function onSelect(p) {
                        return _this2.handleOnSelect(p);
                    }
                })
            );
        }
        ...
        key: 'handleOnSelect',
        value: function handleOnSelect(value) {
            CkEditorApi.executeCommand('SpecialCharacterCommand', { value: value });
        }
    }]);

    return SpecialCharacterSelector;
...
(0, _neosUiExtensibility2.default)('NeosRulez.Neos.CkEditor.SpecialCharacters', {}, function (globalRegistry, _ref) {
    ...
    ckEditorConfig.set('NeosRulez.Neos.CkEditor.SpecialCharacter_Emojis', function (ckEditorConfiguration, _ref3) {
